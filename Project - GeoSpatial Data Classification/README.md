...
In this project, have applied the concept of **feature engineering** for pre-processing and cleaning of the data. After pre-processing of the data, it was **hierarchically classified** into a tree structure by exploring to find the relation among the classes. Further, applied classification algorithm such as **Random Forest, Decision Tree** on the hierarchical tree structure classified data as well as flat structured data. Compare model for tree structure as well as flat structure using **statistical t-test**.
